...
**Senior Technical Support Specialist @ [OpenText](https://www.opentext.com)** · Ex-Hasura ([PromptQL](https://promptql.io/)) · Ex-Broadcom (VMware)
...
- **[Claude Meter](https://github.com/sanchitkd/claude-meter)** — open-source (MIT) macOS menu-bar app showing Claude usage limits · [claude.sanchitkd.com](https://claude.sanchitkd.com)
- **[Tulip](https://tulip.sanchitkd.com)** — self-hosted text-to-image; Cloudflare Worker → queue → an outbound-only Mac running Stable Diffusion
- **[Knowledge Base](https://kb.sanchitkd.com/vmware/)** — 49-concept VMware & networking guide with interactive troubleshooting trees

# 🎓 Verified Certifications
<a href="https://www.credly.com/badges/3573b6f0-2af5-4dc5-b0fd-56df25a5470c/public_url" target="_blank"><img src="https://github.com/user-attachments/assets/090ee161-96a0-4237-b1d6-e1e20ddb3ecb" alt="AWS Certified Solutions Architect – Associate" width="140" height="140"></a>
